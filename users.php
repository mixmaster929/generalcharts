		...
		<div class="card col-lg-12">
			...
			<tbody>
				<?php
 					...
 					$type = array("","Admin","Partner","Alumnus/Alumna");
...
$('.delete_user').click(function(){
		_conf("Esta seguro que desea eliminar el usuario?","delete_user",[$(this).attr('data-id')])
	})
	function delete_user($id){
		...
		$.ajax({
			...
			success:function(resp){
				if(resp==1){
					alert_toast("Se elimino el usuario con exito",'success')
					setTimeout(function(){
						location.reload()
					},1500)
